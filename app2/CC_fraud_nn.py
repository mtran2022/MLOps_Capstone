...
def load_clf():
  ...
  global cat_var_trans_dict, NNClassifier, top100_retailers_2015_ls, scaler

  NNClassifier = load_model('app2/nn_model.h5',custom_objects={'f1':f1})

  with open('app2/cat_var_trans_dict.json', 'r') as f:
    cat_var_trans_dict =  json.load(f)

  with open('app2/top100_retailers_2015.csv', 'r') as f:
  ...
  scaler = joblib.load('app2/scaler.joblib')
